...
#
#             if (i < (data_len -(data_len%4))+16) & (i >= 4):
#                 #     获取最近4天的历史成交量
...
#         shangYingPrice = dayMax-nowCloseRice
#         shiTiPrice = nowCloseRice-nowOpenRice
#         scale = shiTiPrice/nowOpenRice*100
#         if (nowOpenRice<fivePrice) & (nowCloseRice>fivePrice) & (fiveVolume>lastVolume) & (shiTiPrice>shangYingPrice) &(scale<4) & (fivePrice>twentyPrice):
#             bar = {}
#             bar['symsol'] = symsol
#             bar['day'] = datetime.now()
#             bar_list.append(bar)
...
#
# Time_threading(60)
# # batch_stock_data('26',60,76+4,4,0)